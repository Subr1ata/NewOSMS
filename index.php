...
<div class="container">
    <div class="jumbotron">
        ...
        Our state-of-art workshops are workshops are conveniently located in many 
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-3 col-sm-6"> <!-- Start 2nd Column -->
                <div class="card shadow-lg mb-2">
                    <div class="card-body text-center">
                        <img src="images/avtar2.jpg" class="img-fluid" style="border-radius:100px;" alt="avt2">
            ...
            <div class="col-lg-3 col-sm-6"> <!-- Start 3rd Column -->
                <div class="card shadow-lg mb-2">
                    <div class="card-body text-center">
                        <img src="images/avtar3.jpg" class="img-fluid" style="border-radius:100px;" alt="avt3">
            ...
            <div class="col-lg-3 col-sm-6"> <!-- Start 4th Column -->
                <div class="card shadow-lg mb-2">
                    <div class="card-body text-center">
                        <img src="images/avtar4.jpg" class="img-fluid" style="border-radius:100px;" alt="avt4">
    ...
    <div class="container">
        <div class="row py-3">
            ...
            <div class="col-md-6 text-right"> <!-- Start 2nd Column -->
                <small>Designed by Subrata Mukherjee &copy; 2020</small>
